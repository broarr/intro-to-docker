...
Digest: sha256:48f2bbe16e546469b92d2f9c70c684b514bf12f23aa4ad...
...
Digest: sha256:bc0a967762b9561b27230cf04cd927a9095febedf9c722...
...
```
Untagged: mariadb:10
Untagged: mariadb@sha256:48f2bbe16e546469b92d2f9c70c684b514bf...
Deleted: sha256:56089178535fa9944adf2b14559c48dac5a75e3633854...
.
.
.
Deleted: sha256:02571d034293cb241c078d7ecbf7a84b83a5df2508f11...
```
...
```
39a65fc0458c3fbfa8e2cca231b600e54e2c2ac1fb5803183f2d3f60385b4a71
```
...
39a65fc0458c  mariadb:10  "docker-entrypoint.s…" ... 3306/tcp  adoring_bohr
```
...
ce7870f9c546  hello-world:v0 "python ./hello-worl…" Exited (0)
```
...
```
eb4fb9dabc36bbf133e467bf9f19e28c865a3181bd60bc4db298e6f6726cc6ac
```
...
```
847e670df0e789b2a728cbdfd1e641cac4e3e839f7643ca8ba89d037ec2d453b
```
...
"my_network": {
    ...
    "NetworkID": "eb4fb9dabc36bbf133e467bf9f19e28c865a3181b...",
    "EndpointID": "2351dd4b378ee3d5fd3b08ae98b54171e7d941b4...",
...
```
<_mysql.connection open to 'maria' at 0x56256d8349e8>
```
